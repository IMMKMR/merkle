...
export const AboutPhilosophySection = () => {
    return (
        <section className="py-28 lg:py-36 bg-white relative border-b border-slate-100">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    >
                        <p className="font-serif text-xl text-slate-600 leading-relaxed">
                            At Merkle Value, we believe knowledge must lead every Bitcoin decision. We structure and steward investor capital responsibly through institutional thinking and long-term discipline. Our mission is to simplify digital asset access so Indian investors participate confidently in the future of wealth.
                        </p>
                    </motion.div>
