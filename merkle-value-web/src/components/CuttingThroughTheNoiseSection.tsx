            ...
            <div className="py-24 lg:py-32 container mx-auto px-6 lg:px-12 text-center max-w-4xl">
                ...
                >
                    ...
                    <p className="font-serif text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto">
                        Headlines create confusion. Hype creates hesitation. Regulatory uncertainty keeps disciplined Indian investors on the sidelines. Merkle Value cuts through that clutter. We simplify the process and provide a clear, regulated structure that protects Indian investors and aligns with global best practices.
                    </p>
                </motion.div>
            </div>
