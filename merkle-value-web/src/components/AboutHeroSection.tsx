  ...
  return (
    <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-[#1A0B2E] pt-20">
      <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full">
         ...
         />
         <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-off-white to-transparent" />
      </motion.div>
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
            <h1 className="text-sm font-bold tracking-[0.3em] text-white/60 uppercase mb-6 drop-shadow-lg">Build Long-Term</h1>
            <h2 className="text-5xl md:text-7xl font-sans font-bold text-white mb-6 leading-[1.1] tracking-tight drop-shadow-2xl">
                Institutional discipline.<br className="hidden md:block" />
                <span className="font-serif italic text-merkle-purple-light">Digital innovation.</span>
            </h2>
        </motion.div>
      </div>
    </section>
