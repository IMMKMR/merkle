        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-end">
          ...
          >
            ...
            <div className="flex items-center gap-4 justify-center lg:justify-start">
              ...
              <span className="font-serif text-white/40 text-sm italic">
                Clarity for disciplined investors navigating the Bitcoin opportunity.
              </span>
            </div>
          </motion.div>
          ...
          >
            <img
              src="images/assets/insights_magnify_crystal.png"
              alt="Digital Scarcity Analytics"
              className="w-full max-w-[500px] h-auto object-contain object-bottom"
              style={{ filter: 'drop-shadow(0 -20px 60px rgba(139, 92, 246, 0.12))' }}
            />
          </motion.div>
